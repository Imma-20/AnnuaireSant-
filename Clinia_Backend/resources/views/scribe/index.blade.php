...
<head>
    ...
    <title>Clinia API Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Dernière mise à jour: June 14, 2025 à {date:H:i}</li>
    </ul>
</div>
...
<p>Documentation complète de l'API Clinia pour la gestion des structures de santé, services, produits, et plus encore.</p>
<aside>
    <strong>Base URL</strong>: <code>http://localhost/api</code>
</aside>
<pre><code>Cette documentation vise à fournir toutes les informations dont vous avez besoin pour travailler avec notre API.
...
<p>Pour authentification, utilisez le token obtenu après connexion. <b>Génération du token de l' API </b>.</p>
